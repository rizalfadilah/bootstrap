...
<head>
    ...
    <title>GALERIAFYO STORE</title>
</head>
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
    <a class="navbar-brand" href="login1.php">AFRIZALFA</a>
        <a class="navbar-brand" href="login1.php" >Home</a>
        <a class="navbar-brand" href="login1.php" >logout</a> 
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                foreach ($kode as $a => $b) { ?>
                                    <tr>
                                        ...
                                        <td><?php number_format($harga[$a], 2, ',', '.') ?></td>
                            ...
                            ?>
                                ...
                                <tr>
                                <form action="ulangan4.php" method="post">
                                <tr>
